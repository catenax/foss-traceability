...
export default {
  ...
  alertHtml: process.env.ALERT_HTML ? process.env.ALERT_HTML : "/config/email/alert-email.html",
  ...
  cronjob: {
    ...
    status: {
      ...
      requestAssetNotAllowed: {
        ...
        schedule: process.env.CRONJOB_SCHEDULE_STATUS_REQUESTASSETNOTALLOWED
          ? process.env.CRONJOB_SCHEDULE_STATUS_REQUESTASSETNOTALLOWED
          : "45 */30 * * * *",
      },
      getAllActiveInvestigation: {
        ...
        schedule: process.env.CRONJOB_SCHEDULE_LIMIT_ACTIVEINVESTIGATION ? process.env.CRONJOB_SCHEDULE_LIMIT_ACTIVEINVESTIGATION : "5 0 22 * * *",
      },
      requestAssetForInvestigation: {
        limit: process.env.CRONJOB_SCHEDULE_LIMIT_REQUESTASSETFORINVESTIGATION
          ? Number(process.env.CRONJOB_SCHEDULE_LIMIT_REQUESTASSETFORINVESTIGATION)
          : 50,
        schedule: process.env.CRONJOB_SCHEDULE_LIMIT_REQUESTASSETFORINVESTIGATION
          ? process.env.CRONJOB_SCHEDULE_LIMIT_REQUESTASSETFORINVESTIGATION
          : "10 */55 * * * *",
      },
      retryRequestAssetForInvestigation: {
        limit: process.env.CRONJOB_SCHEDULE_LIMIT_RETRYREQUESTASSETFORINVESTIGATION
          ? Number(process.env.CRONJOB_SCHEDULE_LIMIT_RETRYREQUESTASSETFORINVESTIGATION)
          : 50,
        schedule: process.env.CRONJOB_SCHEDULE_LIMIT_RETRYREQUESTASSETFORINVESTIGATION
          ? process.env.CRONJOB_SCHEDULE_LIMIT_RETRYREQUESTASSETFORINVESTIGATION
          : "15 5 */3 * * *",
      },
      qualityAlert: {
        limit: process.env.CRONJOB_SCHEDULE_LIMIT_QUALITYALERT ? Number(process.env.CRONJOB_SCHEDULE_LIMIT_QUALITYALERT) : 50,
        schedule: process.env.CRONJOB_SCHEDULE_STATUS_QUALITYALERT ? process.env.CRONJOB_SCHEDULE_STATUS_QUALITYALERT : "15 */5 * * * *",
        timeInterval: process.env.CRONJOB_SCHEDULE_STATUS_QUALITYALERT_TIME_INTERVAL
          ? Number(process.env.CRONJOB_SCHEDULE_STATUS_QUALITYALERT_TIME_INTERVAL)
          : 2,
      },
    },
  },
  kafka: {
    ...
    alertHost: process.env.KAFKA_QUALITY_ALERT_HOST ? process.env.KAFKA_QUALITY_ALERT_HOST : "cx-dev-taas-kafka.taas.svc.cluster.local",
    ...
    alertGroupId: process.env.KAFKA_QUALITY_ALERT_GROUP_ID ? process.env.KAFKA_QUALITY_ALERT_GROUP_ID : "taasQualityAlert",
    alertHistoryGroupId: process.env.KAFKA_ALERT_HISTORY_GROUP_ID ? process.env.KAFKA_ALERT_HISTORY_GROUP_ID : "taasAlertHistory",
    failedIngestStatsTopicName: process.env.KAFKA_FAILED_INGEST_STATS_TOPIC_NAME
      ? process.env.KAFKA_FAILED_INGEST_STATS_TOPIC_NAME
      : "failedAssetReport",
    ingestStatsTopicName: process.env.KAFKA_INGEST_STATS_TOPIC_NAME ? process.env.KAFKA_INGEST_STATS_TOPIC_NAME : "aemsStatistics",
  },
  ...
  swagger: {
    ...
    info: {
      ...
      description: process.env.API_SWAGGER_DESCRIPTION ? process.env.API_SWAGGER_DESCRIPTION : "API service for exchanging assets via PartChain",
