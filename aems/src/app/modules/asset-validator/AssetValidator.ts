...
const Asset = t.intersection([
  t.type(
    //required keys
    {
      serialNumberManufacturer: withMessage(NonEmptyString, () => "serialNumberManufacturer has to be present and not be an empty string!"),
      serialNumberCustomer: withMessage(NonEmptyString, () => "serialNumberCustomer has to be present and not be an empty string!"),
      ...
      manufacturer: withMessage(NonEmptyString, () => "manufacturer has to be present and not be an empty string!"),
      qualityStatus: withMessage(t.keyof({ OK: null, NOK: null, FLAG: null }), () => "Only allowed values for qualityStatus are OK, NOK and FLAG"),
      ...
      productionCountryCodeManufacturer: withMessage(
        t.keyof(Object.keys(Country).reduce((o, key) => ({ ...o, [key]: null }), {})),
        () =>
