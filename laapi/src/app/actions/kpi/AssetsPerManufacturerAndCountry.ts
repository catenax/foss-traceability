 ...
 * @constructor
 */
export default async function assetsPerManufacturerAndCountry(req: any, res: any, next: any) {
    const client = new KPIClient;
    const jwt = JWT.parseFromHeader(
        req.header('Authorization')
    );

    return  client.assetsPerManufacturerAndCountry(
