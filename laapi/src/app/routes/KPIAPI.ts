...
import AffectedParts from "../actions/kpi/AffectedParts";
import GetTopAlerts from "../actions/kpi/GetTopAlerts";

/**
 * Assets per day route
 */
const assetsPerDay = route(
  "assets-per-day",
  AssetsPerDay,
  getRouteOptions("post")
);

/**
 * Assets per country and manufacturer
 */
const assetsPerManufacturerAndCountry = route(
  "assets-per-MaC",
...
/**
 * Get affected parts for dashboard
 */
const affectedParts = route(
  "affected-parts",
  AffectedParts,
  getRouteOptions("get")
);
 ...
 */
const topAlerts = route("alert-summary", GetTopAlerts, getRouteOptions("get"));
