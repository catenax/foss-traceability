...
import GetRelationships from "../actions/offHLFDB/GetRelationships";
import GetQualityAlert from "../actions/offHLFDB/GetQualityAlert";
 ...
 * @deprecated (replaced by Assets.getAssets)
 */
 ...
 * Get asset list route
 */
const getRelationships = route('relationships', GetRelationships, getRouteOptions("get"));
 ...
 * Get quality alert
 */
const getQualityAlert = route('quality-alert', GetQualityAlert, getRouteOptions("get"));
