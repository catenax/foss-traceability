...
export class AclService {
  ...
  public acceptRequest(targetOrg: string, comment: string): Observable<ACLResponse> {
    return this.apiService.post<ACLResponse>(`${this.url.aems}access-mgmt/accept-access-request`, {
      targetOrg: targetOrg,
      comment: comment,
    });
  }
  ...
  public denyRequest(targetOrg: string, comment: string): Observable<ACLResponse> {
    return this.apiService.post<ACLResponse>(`${this.url.aems}access-mgmt/deny-access-request`, {
      targetOrg: targetOrg,
      comment: comment,
    });
  }
  ...
  public getAccessRecommendations(): Observable<string[]> {
    return this.apiService
      .get<{ status: number; resultLength?: number; data: string[] }>(
        `${this.url.aems}access-mgmt/get-access-request-recommendations`,
      )
  ...
  public removeAccess(targetOrg: string, comment: string): Observable<ACLResponse> {
    return this.apiService.post<ACLResponse>(`${this.url.aems}access-mgmt/remove-access`, {
      targetOrg: targetOrg,
      comment: comment,
    });
  }
  ...
  public requestAccess(targetOrg: string, comment: string): Observable<ACLResponse> {
    return this.apiService.post<ACLResponse>(`${this.url.aems}access-mgmt/request-access`, {
      targetOrg: targetOrg,
      comment: comment,
    });
  }
