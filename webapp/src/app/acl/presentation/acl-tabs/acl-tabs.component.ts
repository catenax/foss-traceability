...
export class AclTabsComponent implements OnChanges {
  ...
  public removeAccess(targetOrg: string): void {
    ...
    const dialogData = new ConfirmDialogModel('Remove Access', message, 'error', true, 'Remove Access', 'Cancel');
  ...
  public denyAccess(targetOrg: string): void {
    ...
    const dialogData = new ConfirmDialogModel('Deny Access', message, 'error', true, 'Deny Access', 'Cancel');
    const dialogRef = this.dialog.open(ConfirmDialogComponent, {
      data: dialogData,
      panelClass: 'custom-dialog-container',
    });
  ...
  public acceptAccess(targetOrg: string): void {
    ...
    const dialogData = new ConfirmDialogModel('Accept Access', message, 'success', true, 'Accept Access', 'Cancel');
    const dialogRef = this.dialog.open(ConfirmDialogComponent, {
      data: dialogData,
      panelClass: 'custom-dialog-container',
    });
