...
export class ReceivedQualityAlertTableBuilder {
  /**
   * Quality type table
   *
   * @static
  ...
  static getTable(): Table {
    const columnsConfig: Array<ColumnConfig> = [
      ...
      {
        fieldName: 'childPartNameManufacturer',
      ...
      },
      {
        ...
        label: 'Child part serial number',
        hide: false,
        width: 3,
        sortable: true,
      },
      ...
      {
        fieldName: 'childCustomerOneid',
        label: 'Child part manufacturer',
        hide: false,
        width: 2,
        sortable: true,
      },
