 ...
 *
 * @export
 * @class QualityAlertListDistributedComponent
 */
@Component({
  selector: 'app-quality-alert-list-distributed',
  templateUrl: './quality-alert-list-distributed.component.html',
})
export class QualityAlertListDistributedComponent {
  /**
   ...
   *
   * @type {GroupedAlert[]}
   * @memberof QualityAlertListDistributedComponent
   */
  public distributedAlerts: GroupedAlert[];
